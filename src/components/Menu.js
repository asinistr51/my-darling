        ...
        <>
            ...
            <div class="animate__animated animate__bounceInUp">
                ...
                {trigger6 && (<div style={{
                    ...
                    <div style={{ display: "flex", justifyContent: 'space-between', marginRight: '20px', marginLeft: '20px' }}><div><div>Судак "Мускат"</div><div style={{ fontSize: '20px' }}>(Филе судака жареное с мускатным орехом, подается с отварным или жаренным картофелем 150/50/30гр.)</div></div><div>380р</div></div>
                </div>)}
